...
{
    public partial class PatientAppointment1 : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            dbcon.AppointmentsTables.Where(t => t.PatientID == result.FirstOrDefault() && t.Date > DateTime.Now).Load();
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            myApp.DoctorID = Convert.ToInt32(DropDownList3.SelectedValue);
            myApp.PatientID = result.FirstOrDefault();
            ...
            {
                if (time == x.Time && myApp.Date == x.Date && myApp.DoctorID == x.DoctorID)
                {
                    eLabel.Visible = true;
